...
export const executeCode = async (req: Request, res: Response) => {
    try {
        ...
        const hasInputInTestCases = test_cases && test_cases.some((tc: any) => tc.input && tc.input.trim() !== '');
        ...
        let mainRuntimeOutput: string | null = null;
        ...
        for (const tc of test_cases) {
            ...
            if (!mainRuntimeOutput) mainRuntimeOutput = stdout || stderr || '';
